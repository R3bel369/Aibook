        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {isAuthenticated ? (
            <div className="relative">
              ...
              >
                <div className="relative">
                  <img
                    src={user.avatar}
                    alt={user.name}
                    className="w-8.5 h-8.5 rounded-xl object-cover ring-2 ring-emerald-500/40 shadow-sm"
                  />
                  <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-slate-900" title="Authenticated Session" />
                </div>
              </button>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-64 saas-card p-2 shadow-2xl z-50 space-y-1 border border-slate-300 dark:border-slate-700">
                  ...
                  <button
                    onClick={() => { logout(); setShowUserMenu(false); onNavigate('auth'); }}
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold text-xs shadow-md hover:scale-105 transition-all flex items-center gap-1.5"
            >
